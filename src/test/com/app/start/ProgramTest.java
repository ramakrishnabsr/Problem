...
public class ProgramTest {
	...
	@Test
	/**
	 * Method tests a Negative scenario of the application. Input file by default picked up by the input.
	 */
	public void testProgram() throws IOException{
		...
		Assert.assertNotSame("how many Credits is glob prok Iron ? glob prok Iron is 782.0 Credits\n" +
